...
public final class Number {
    ...
    public static final int FOURTEENTH = 14;
    public static final int FIFTEENTH = 15;
    public static final int SIXTEENTH = 16;
    public static final int SEVENTEENTH = 17;
    public static final int EIGHTEENTH = 18;
    public static final int NINETEENTH = 19;
    ...
    public static final int TWENTY_FOURTH = 24;
    public static final int TWENTY_FIFTH = 25;
    public static final int TWENTY_SIXTH = 26;
    public static final int TWENTY_SEVENTH = 27;
    public static final int TWENTY_EIGHTH = 28;
